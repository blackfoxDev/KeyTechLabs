...
$sql="SELECT * FROM projects WHERE Projectid = '".$q."'";
...
while($row = mysql_fetch_array($result)) {
    ...
    echo "<td><form action='/jTable-PHP-Samples/Codes/Projectupgradeprocess.php' method='post'>	
      ...
      <option value='".$q."'>".$q."</option>
       <select>
   <textarea id='edit' name='ProjectDesc' class='text' cols='86' rows ='20'><h1>Project1.Name - (Project1.HtmLTemplate1.Name) Nindo Demo Lvl 1</h1>
