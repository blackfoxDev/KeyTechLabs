...
$sql="SELECT * FROM topics WHERE Topicid = '".$q."' AND Techid= '1' AND Subjectid = '2'";
...
while($row = mysql_fetch_array($result)) {
    ...
    echo "<td>" . $row['TopicDesc'] . "</td>";
    echo "<td><form action='/jTable-PHP-Samples/Codes/Topicupgradeprocess.php' method='post'>	
    
      <select name='techid'>
      <option value='".$q."'>".$q."</option>
       <select>
   <textarea id='edit' name='topicdesc' class='text' cols='86' rows ='20'><h1>Topic1.Name - (Topic1.HtmLTemplate1.Name) Nindo Demo Lvl 1</h1>
